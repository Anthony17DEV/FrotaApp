...
DHTMLSuite.config.prototype = {
	...
	init : function()
	{
		this.imagePath = '../../imagens/menu/';	// Path to images		
		this.cssPath = '../../estilos/menu/';	// Path to images		
	}	
	// }}}
	,
	// {{{ setCssPath()
...
DHTMLSuite.menuBar.prototype = {
	...
	__setBasicEvents : function(){
		...
		/*
		DHTMLSuite.commonObj.addEvent(document.documentElement,"mouseover",this.hideSubMenus2);
		setTimeout('DHTMLSuite.variableStorage.arrayDSObjects[' + ind + '].hideSubMenus()',15);
		*/
		//DHTMLSuite.commonObj.addEvent(document.documentElement,"mouseover",alert('aa'));
//		DHTMLSuite.commonObj.addEvent(document.documentElement,"mouseover",this.hideSubMenus);
