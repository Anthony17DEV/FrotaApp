...
//alert('asdf2'+nome);
	...
	//setTimeout("foco_combo_net('"+nome+"')",1);
	
	//setTimeout("window.frames['frame_"+nome+"'].document.forms[0].elements[3].focus()",1);
